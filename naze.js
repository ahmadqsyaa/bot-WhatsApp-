...
const nyoutube = ('© rick')  //ubah di config biar ngk emror
...
const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')  
 if(time2 < "23:59:00"){
var ucapanWaktu = 'selamat malam bro'
 }
 if(time2 < "19:00:00"){
var ucapanWaktu = 'Selamat Sore bro'
 }
 if(time2 < "18:00:00"){
var ucapanWaktu = 'selamat sore bro'
 }
 if(time2 < "15:00:00"){
var ucapanWaktu = 'selamat siang bro'
 }
 if(time2 < "11:00:00"){
var ucapanWaktu = 'selamat siang bro'
 }
 if(time2 < "05:00:00"){
var ucapanWaktu = 'selamat pagi bro'
 } 
...
//PEMBATAS ADMIN & OWNER=======================================
  ...
  //PESAN OTOMATIS 
            break
 case 'rik': case 'erik': case 'Rik': case 'Erik': case 'ric': {
                naze.sendMessage(m.chat, { 
 document: fs.readFileSync('./media/doc/fake.pptx'),
 fileName : pesanpanggil + (` | pesan dari ${pushname}`),
 fileLength: jumhal,
  pageCount: jumlha,
  mimetype: `${filsk}`,
            }, { quoted: m })
 ...
 fileLength: jumhal,
  ...
  naze.sendMessage(m.chat, buttonMessage, {quoted: fkontak})
            ...
            case 'req': case 'request': {
               ...
               let buttons = [{ buttonId: 'hehehe', buttonText: { displayText: 'makasi' }, type: 1 }]
...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Pesan : ${q ? q : 'kosong'}*\n\n`
	    ...
	    break
            ...
            m.reply(`Vote dimulai!\n\n*${prefix}upvote* - untuk ya\n*${prefix}devote* - untuk tidak\n*${prefix}cekvote* - untuk mengecek vote\n*${prefix}hapusvote* - untuk menghapus sesi vote`)
            vote[m.chat] = [q, [], []]
            await sleep(1000)
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: 'devote'}, type: 1}
            ...
            if (wasVote) throw 'you udh vote njay🗿'
...
*${prefix}hapusvote* - untuk menghapus vote`
            let buttonsUpvote = [
              {buttonId: `${prefix}upvote`, buttonText: {displayText: 'upvote'}, type: 1},
              {buttonId: `${prefix}devote`, buttonText: {displayText: 'devote'}, type: 1},
              {buttonId: `${prefix}cekvote`, buttonText: {displayText: 'cek hasil vote'}, type: 1}
            ]
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'sticker', buttonText: { displayText: 'BUAT STICKER' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: 'ALL MENU TEXT' }, type: 1 },{ buttonId: 'simplemenu', buttonText: { displayText: 'All MENU LIST' }, type: 1 }]
            let buttonMessage = {
  document: fs.readFileSync('./media/doc/fake.pptx'),
  fileName : akulaku + (` | Halo ${pushname}`),
  mimetype: `${filsk}`,
 ...
 break
            ...
            let kukiw = `*Kak ${pushname}*`
	           ...
	           rows: [
                ...
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*${ucapanWaktu}*`, `LIST MENU BOT`, sections, fkontak)
            }
            break
            case 'mgroup': {
goup = `╭──❍ *Group Menu*
...
╰────❍
`
                let buttons = [{ buttonId: 'MENU', buttonText: { displayText: 'BACK' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: 'LIST MENU' }, type: 1 }]
